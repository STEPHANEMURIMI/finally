...
class ProductViewModel(var navController:NavHostController, var context: Context) {
    ...
    fun uploadProduct(shopname:String, contact:String,productName:String,lacation:String, filePath:Uri){
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var product = Product(shopname,lacation,contact,productName,imageUrl,productId)
